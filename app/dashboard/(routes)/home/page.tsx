...
const HomePage = () => {
  ...
  return (
    <div
      className={cn(
        "relative h-screen pt-10 px-4 pb-4 lg:pl-[264px] lg:pt-8 lg:pb-20",
        {
    ...
    >
      <div className="w-full relative">
        {/* header */}
        <div className="sticky mt-8 lg:mt-0 right-0 left-0 top-4 flex items-center justify-between">
        ...
        >
          <div className="flex flex-col gap-4">
            <div className="flex items-center justify-between">
              ...
              <Button className="hidden relative z-10 bg-white text-[#484856] hover:bg-white hover:opacity-80">
                News
              </Button>
            </div>
        ...
        <div className="relative">
          <div
            className="relative p-4 z-50 bg-[#F8FAFE] dark:bg-[#1E1E1E] shadow-lg dark:shadow-none dark:border-[0.5px] dark:border-[#363638]
         rounded-xl mt-8"
          >
          ...
          <div className="absolute z-40 rounded-xl  top-4 left-4 right-4 h-full bg-[#F8FAFE] dark:bg-[#1E1E1E] shadow-lg dark:shadow-none dark:border-[0.5px] dark:border-[#363638]"></div>
          <div className="absolute z-30 rounded-xl  top-8 left-8 right-8 h-full bg-[#F8FAFE] dark:bg-[#1E1E1E] shadow-lg dark:shadow-none dark:border-[0.5px] dark:border-[#363638]"></div>
        </div>
      </div>
    </div>
  );
